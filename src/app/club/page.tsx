...
function shieldSVG(id: string, c1: string, c2: string) {
  const s: Record<string, string> = {
    classic: `<path d="M22 2L40 8L40 24Q40 36 22 42Q4 36 4 24L4 8Z" fill="${c1}"/><path d="M22 2L31 5L31 24Q31 33 22 38Q13 33 13 24L13 5Z" fill="${c2}" opacity=".7"/><text x="22" y="26" text-anchor="middle" font-size="11" font-weight="700" fill="white" font-family="sans-serif">FC</text>`,
    round: `<circle cx="22" cy="22" r="19" fill="${c1}"/><circle cx="22" cy="22" r="13" fill="${c2}" opacity=".7"/><text x="22" y="26" text-anchor="middle" font-size="10" font-weight="700" fill="white" font-family="sans-serif">FC</text>`,
    star: `<polygon points="22,2 27,15 41,15 30,24 34,38 22,30 10,38 14,24 3,15 17,15" fill="${c1}"/><polygon points="22,8 26,18 36,18 28,24 31,34 22,28 13,34 16,24 8,18 18,18" fill="${c2}" opacity=".7"/>`,
    diamond: `<polygon points="22,2 40,22 22,42 4,22" fill="${c1}"/><polygon points="22,9 33,22 22,35 11,22" fill="${c2}" opacity=".7"/><text x="22" y="26" text-anchor="middle" font-size="9" font-weight="700" fill="white" font-family="sans-serif">FC</text>`,
    crest: `<path d="M22 2L38 6L38 20Q38 34 22 42Q6 34 6 20L6 6Z" fill="${c1}"/><path d="M22 8L32 11L32 22Q32 31 22 37Q12 31 12 22L12 11Z" fill="${c2}" opacity=".6"/><circle cx="22" cy="21" r="5" fill="white" opacity=".8"/>`,
    modern: `<rect x="4" y="4" width="36" height="36" rx="8" fill="${c1}"/><rect x="10" y="10" width="24" height="24" rx="5" fill="${c2}" opacity=".7"/><text x="22" y="26" text-anchor="middle" font-size="11" font-weight="700" fill="white" font-family="sans-serif">FC</text>`,
    pentagon: `<polygon points="22,2 40,15 33,36 11,36 4,15" fill="${c1}"/><polygon points="22,8 34,18 29,32 15,32 10,18" fill="${c2}" opacity=".7"/>`,
    hexagon: `<polygon points="22,2 38,12 38,32 22,42 6,32 6,12" fill="${c1}"/><polygon points="22,9 32,15 32,29 22,35 12,29 12,15" fill="${c2}" opacity=".7"/>`,
  }
        ...
        <div style={s.card}>
          ...
          <div style={{ ...s.cardBody, display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <svg width="52" height="52" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg"
              dangerouslySetInnerHTML={{ __html: shieldSVG(shield, colorP, colorS) }} />
            <div style={{ flex: 1 }}>
              ...
              {SHIELDS.map(sh => (
                <div key={sh.id} onClick={() => setShield(sh.id)}
                  ...
                  <svg width="38" height="38" viewBox="0 0 44 44" xmlns="http://www.w3.org/2000/svg"
                    dangerouslySetInnerHTML={{ __html: shieldSVG(sh.id, colorP, colorS) }} />
